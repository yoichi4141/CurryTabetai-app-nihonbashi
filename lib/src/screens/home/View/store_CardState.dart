...
class StoreTimelineCard extends StatefulWidget {
  final StoreTimelineItem item; //TimelineItem オブジェクトを受け取る
...
class _TimelineCardState extends State<StoreTimelineCard> {
  @override
